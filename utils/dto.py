...
class adminProductDTO: # 임원진 물품 DTO
    ...
    admin_product_response_all = api.inherit('admin_product_response_all',admin_product_response,{ #정상적으로 결과를 출력했을 시의 모델
        ...
        'user_id':nullable(fields.String)(description='대여 회원 id(대여 물품 아닐시 null)'),
        'deadline':nullable(fields.String)(description='반납기한(대여 물품 아닐시 null)'),
        'rent_day':nullable(fields.String)(description='대여일시(대여 물품 아닐시 null)'),
        'return_day':nullable(fields.String)(description='반납한 날짜(대여 물품 아닐시 null)'),
    })
